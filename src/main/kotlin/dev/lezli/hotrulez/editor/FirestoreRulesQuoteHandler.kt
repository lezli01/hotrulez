 ...
 * [FirestoreRulesTokenTypes.STRING] token, so one token in the set covers both.
 */
class FirestoreRulesQuoteHandler : SimpleTokenSetQuoteHandler(FirestoreRulesTokenTypes.STRING)
