 ...
 * scoping and path-variable shadowing via [FirestoreRulesScopes].
 *
 ...
 */
class FirestoreRulesReference(element: FirestoreRulesReferenceExpression) :
    PsiReferenceBase.Poly<FirestoreRulesReferenceExpression>(
        element,
    ...
    override fun multiResolve(incompleteCode: Boolean): Array<ResolveResult> =
        FirestoreRulesScopes.resolve(element)
